...
export default function VivanderosPage() {
  ...
  return (
    ...
    >
      ...
      <main className="flex flex-col items-center justify-center flex-1 min-h-[60vh]">
        <h1 className="text-2xl font-bold mb-4">Vivanderos</h1>
        <p>Conoce a los vivanderos aliados del Mercado Comunitario Girardot.</p>
      </main>
      <Footer />
    </div>
  );
