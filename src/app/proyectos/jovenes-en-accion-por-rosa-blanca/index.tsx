...
import Nicol from "@/app/proyectos/jovenes-en-accion-por-rosa-blanca/nicol.jpg";
import Kevin from "@/app/proyectos/jovenes-en-accion-por-rosa-blanca/kevin.jpg";
import Maria from "@/app/proyectos/jovenes-en-accion-por-rosa-blanca/daniela.jpg";

export default function JovenesEnAccionPorRosaBlanca() {
  return (
    <div className="max-w-3xl mx-auto py-10 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col items-center bg-white dark:bg-[#23232a] rounded-lg shadow p-4">
          ...
          <div className="text-sm text-gray-600 dark:text-gray-300">
            Estudiante de colegio, gestora cultural
          </div>
        </div>
      </div>
